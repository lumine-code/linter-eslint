const { BufferedNodeProcess, Range } = require("lumine");
...
class WorkerClient {
  ...
  ensureEngine() {
    ...
    this.enginePromise = this.request("init", {
      ...
      useBuiltin: lumine.config.get("linter-eslint.useBuiltin"),
      debugMode: lumine.config.get("linter-eslint.debugMode"),
    })
      .then((result) => {
