...
- **[busy-signal.reporter](https://lumine-code.github.io/docs.html#services/busy-signal.reporter)** (`^1.0.0`): consumed to show busy messages while ESLint engines load and project scans run.
